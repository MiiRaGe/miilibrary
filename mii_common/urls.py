...
urlpatterns = patterns(
    ...
    url(r'^report/(?P<report_id>[0-9]+)/$', 'mii_interface.views.report', name='report'),
    ...
    url(r'^rpc/unpack_sort_index', 'mii_interface.views.start_unpack_sort_indexer', name='unpack_sort_index'),
